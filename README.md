...
**LVTS** — A modern, digital solution for automating visitor registration and monitoring in library environments.
...
| 🏛️ **College & Department Management** | Flexible college and department configuration |
...
│   │   └── Admin.tsx    # Main dashboard (all sections)
│   └── login/           # Login page with auth guard
├── routes/              # Route configuration & AuthRoute guard
...
```bash
git clone https://github.com/your-username/library-visitor-tracking-system.git
cd library-visitor-tracking-system
```
...
4. On success, the user is redirected to the admin dashboard
...
Developed for **New Era University (NEU) Library** to modernize and streamline library visitor management.

---

<div align="center">
  <sub>Built with ❤️ for NEU Library</sub>
</div>